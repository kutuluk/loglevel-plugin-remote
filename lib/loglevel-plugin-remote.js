(function (global, factory) {
  ...
  var defaults = {
    url: window.location.origin ? window.location.origin + '/logger' : document.location.origin + '/logger',
    call: true,
    timeout: 0,
  ...
  var apply = function apply(logger, options) {
    ...
    var push = function push(array, stack) {
      if (stack) {
  ...
  var saveRemote = window ? window.remote : undefined;
